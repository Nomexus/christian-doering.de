<template>
  <div class="content">
    ...
    <p>Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gew&auml;hrleisten. Andere
      Daten
      k&ouml;nnen zur Analyse Ihres Nutzerverhaltens verwendet werden.</p> <h4>Welche Rechte haben Sie bez&uuml;glich
    Ihrer Daten?</h4>
    ...
    <h2>2. Hosting</h2>
    <h3>Hetzner</h3>
    <p>Wir hosten unsere Website bei Hetzner. Anbieter ist die Hetzner Online GmbH, Industriestr. 25, 91710 Gunzenhausen
    ...
    <p>Im Falle von Verst&ouml;&szlig;en gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer
      ...
      mutma&szlig;lichen
      Versto&szlig;es zu. Das Beschwerderecht besteht unbeschadet anderweitiger verwaltungsrechtlicher oder
      gerichtlicher
      Rechtsbehelfe.</p>
    ...
    <p>Quelle: <a rel="noopener nofollow" href="https://www.e-recht24.de" target="_blank">https://www.e-recht24.de</a>
    </p>
  </div>
</template>
