<template>
  <div class="content">
    ...
    <h2 class="h1 mb-4 mt-0 text-center styled">{{ t('home.currentProjects') }}</h2>
    ...
    <ContentDivider class="mb-4 mt-4" />
    <h2 class="h1 mb-4 mt-0 text-center styled">{{ t('home.myExperience') }}</h2>
    <div class="experience-home mt-0">
      <div class="resume-default">
        ...
        <DefaultRow
            date="01/2018 – 06/2022"
            :title="t('experience.ow2.title')"
            :where="t('experience.ow2.employer')">
        </DefaultRow>
        <DefaultRow
            date="04/2013 – 12/2017"
